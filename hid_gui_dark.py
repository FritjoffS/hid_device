...
def main():
    root = ThemedTk(theme="equilux")  # Use a dark theme from ttkthemes
    ...
    label = ttk.Label(root, text="Click 'Check Devices' to scan HID devices and check status.")
    label.pack(pady=10)

    check_button = ttk.Button(root, text="Check Devices", command=check_devices)
    ...
    global result_text
    result_text = tk.Text(root, height=20, width=80, wrap=tk.WORD, bg='black', fg='white', yscrollcommand=scrollbar.set)
